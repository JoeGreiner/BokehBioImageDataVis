...
# create hovers
img_hover = bokeh_fig.add_image_hover(key='path_to_images', width=700, height=500) # will stretch to fit width and height, aspect ratio is maintained
vid_hover = bokeh_fig.add_video_hover(key='path_to_videos', width=700, height=500)
